                ...
                <table class="datatable table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ date('h:i:A',strtotime($item->shift_start)) }}</td>
                            <td>{{ date('h:i:A',strtotime($item->shift_end)) }}</td>
                            <td>{{ $item->branch_name }}</td>
                            <td>
                                        
                                @if ($item->status_id == 1)
                                    <span class="badge bg-success set-status" id="status_{{ $item->id_shift}}"
                                        onclick="setActive({{ $item->id_shift}})">Active</span>
                                @else
                                    <span class="badge bg-danger set-status" id="status_{{ $item->id_shift}}"
                                        onclick="setActive({{ $item->id_shift}})">Inactive</span>
                                @endif

                            </td>
                            <td><a data-id="{{ $item->id_shift}}" data-bs-toggle="modal" data-bs-target="#EditModal"
