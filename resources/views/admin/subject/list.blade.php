                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($item->status_id == 1)
                                    <span class="badge bg-success set-status" id="status_{{ $item->id_subject}}"
                                        onclick="setActive({{ $item->id_subject}})">Active</span>
                                @else
                                    <span class="badge bg-danger set-status" id="status_{{ $item->id_subject}}"
                                        onclick="setActive({{ $item->id_subject}})">Inactive</span>
                                @endif

                            </td>
                            <td><a data-id="{{ $item->id_subject}}" data-bs-toggle="modal" data-bs-target="#EditModal"
