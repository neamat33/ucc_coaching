        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">Income Edit</h3>
                </div>
            </div>
        </div> <!-- Row end  -->
        <form action="{{ route('income.update',encrypt($single->id)) }}" method="post">
        @csrf
        @method('put')
            ...
            <div class="col-lg-12">
                <div class="card mb-3">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                        <h6 class="m-0 fw-bold">income Information</h6>
                    </div>
                    <div class="card-body">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <input type="hidden" name="log_id" value="{{ $single->log_id }}">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">income title</label><label class="text-danger"> *</label>
