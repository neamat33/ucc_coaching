...
<?php $__env->startSection('page-title', 'Room List'); ?>
            ...
            <div class="card-datatable table-responsive pt-0">
                <table class="datatable table">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if($item->status_id == 1): ?>
                                    <span class="badge bg-success set-status" id="status_<?php echo e($item->id_room); ?>"
                                        onclick="setActive(<?php echo e($item->id_room); ?>)">Active</span>
                                <?php else: ?>
                                    <span class="badge bg-danger set-status" id="status_<?php echo e($item->id_room); ?>"
                                        onclick="setActive(<?php echo e($item->id_room); ?>)">Inactive</span>
                                <?php endif; ?>

                            </td>
                            <td><a data-id="<?php echo e($item->id_room); ?>" data-bs-toggle="modal" data-bs-target="#EditModal"
    ...
    <div class="modal fade  mb-5" id="EditModal" tabindex="-1" role="dialog"
        ...
        <script>
            $(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('admin/room_edit')); ?>",
                    data: {
                        id: id
                    },
                    success: function(data) {
                        ...
                        var formActionUrl = "<?php echo e(url('admin/room/update')); ?>/" + id;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\xampp\htdocs\ucc_coaching\resources\views/admin/room/list.blade.php ENDPATH**/ ?>