                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if($item->status_id == 1): ?>
                                    <span class="badge bg-success set-status" id="status_<?php echo e($item->id_class); ?>"
                                        onclick="setActive(<?php echo e($item->id_class); ?>)">Active</span>
                                <?php else: ?>
                                    <span class="badge bg-danger set-status" id="status_<?php echo e($item->id_class); ?>"
                                        onclick="setActive(<?php echo e($item->id_class); ?>)">Inactive</span>
                                <?php endif; ?>

                            </td>
                            <td><a data-id="<?php echo e($item->id_class); ?>" data-bs-toggle="modal" data-bs-target="#EditModal"
    ...
    <div class="modal fade  mb-5" id="EditModal" tabindex="-1" role="dialog"
        ...
        <script>
            $(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(url('admin/class_edit')); ?>",
                    data: {
                        id: id
                    },
                    success: function(data) {
                        ...
                        var formActionUrl = "<?php echo e(url('admin/class/update')); ?>/" + id;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\xampp\htdocs\ucc_coaching\resources\views/admin/class/list.blade.php ENDPATH**/ ?>